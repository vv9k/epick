...
impl ColorSpace {
    pub fn reference_whitepoint(&self) -> Illuminant {
        ...
        match &self {
            ...
            BestRGB => Illuminant::D50,
            BetaRGB => Illuminant::D50,
            BruceRGB => Illuminant::D65,
            CIERGB => Illuminant::E,
            ColorMatchRGB => Illuminant::D50,
            DonRGB4 => Illuminant::D50,
            ECIRGB => Illuminant::D50,
            EktaSpacePS5 => Illuminant::D50,
            NTSCRGB => Illuminant::C,
            PALRGB => Illuminant::D65,
            ProPhotoRGB => Illuminant::D50,
            SMPTECRGB => Illuminant::D65,
            SRGB => Illuminant::D65,
    ...
    pub fn rgb_matrix(&self) -> RgbSpaceMatrix {
        ...
        match &self {
            ...
            BruceRGB => BRUCE_RGB,
            CIERGB => CIE_RGB,
            ColorMatchRGB => COLOR_MATCH_RGB,
            DonRGB4 => DON_RGB_4,
            ECIRGB => ECI_RGB,
            EktaSpacePS5 => EKTA_SPACE_PS5,
            NTSCRGB => NTSC_RGB,
            PALRGB => PAL_RGB,
            ProPhotoRGB => PRO_PHOTO_RGB,
            SMPTECRGB => SMPTEC_RGB,
    ...
    pub fn rgb_matrix_inverse(&self) -> RgbSpaceMatrix {
        ...
        match &self {
            ...
            BestRGB => BEST_RGB_INVERSE,
            BetaRGB => BETA_RGB_INVERSE,
            BruceRGB => BRUCE_RGB_INVERSE,
            CIERGB => CIE_RGB_INVERSE,
            ColorMatchRGB => COLOR_MATCH_RGB_INVERSE,
            DonRGB4 => DON_RGB_4_INVERSE,
            ECIRGB => ECI_RGB_INVERSE,
            EktaSpacePS5 => EKTA_SPACE_PS5_INVERSE,
            NTSCRGB => NTSC_RGB_INVERSE,
            PALRGB => PAL_RGB_INVERSE,
            ProPhotoRGB => PRO_PHOTO_RGB_INVERSE,
            SMPTECRGB => SMPTEC_RGB_INVERSE,
            SRGB => SRGB_INVERSE,
